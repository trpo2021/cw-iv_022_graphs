...
int main(int argc, char *argv[])
{
    if(argv[1] == NULL)
    {
        ...
        printf("\nРебро [1 - 2] = 17\nРебро [2 - 3] = 13\nРебро [3 - 4] = 15\n");
        printf("Ребро [4 - 1] = 25\nРебро [1 - 3] = 25\nРебро [2 - 4] = 16\n");
        printf("\nВыберите две вершины с помощью ключей '-b X' и '-e X', где X - номер вершины, b - стартовый город, e - конечный\n");
    ...
    {
		printf("Error: сперва введите стартовый город, с помощью ключа '-b', например '-b 3'\n");
		return -1;
    }
    ...
    {
		printf("Error: введите конечный город (или значение стартового), с помощью ключа '-e', например '-e 2'\n");
		return -1;
    }
